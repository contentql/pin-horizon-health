          ...
          <div className='col-lg-7'>
            ...
            <div className='cs_about_img'>
              ...
              <div className='cs_about_mini_img'>
                <Image
                  src={(data?.spin_image as Media)?.url || ''}
                  alt={(data?.spin_image as Media)?.alt || 'Mini'}
                  className='cs_rotate_animation'
                  height={191}
                  width={191}
                />
                <Image
                  src={(data?.spin_logo as Media)?.url || ''}
                  alt={(data?.spin_logo as Media)?.alt || 'Right'}
          ...
          <div className='col-lg-5'>
            <div className='cs_about_content'>
              <div className='cs_section_heading cs_style_1'>
                <h2 className='cs_section_title cs_fs_72 m-0'>{data?.title}</h2>
                <div className='cs_height_5' />
                <h3 className='cs_section_subtitle text-uppercase cs_accent_color cs_semibold cs_accent_color cs_fs_32 m-0'>
                  {data?.sub_title}
                </h3>
              </div>
              <Spacing md='72' lg='72' />
