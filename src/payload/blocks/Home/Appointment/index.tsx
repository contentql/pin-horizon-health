import { AppointmentType, Media } from '@payload-types'
import Image from 'next/image'

import AppointmentForm from '@/components/marketing/home/AppointmentForm'
import SectionHeading from '@/components/marketing/home/SectionHeading'
import Spacing from '@/components/marketing/home/Spacing'

export default function Appointment(data: AppointmentType) {
  return (
    <>
          ...
          <div className='row align-items-center cs_gap_y_40'>
            ...
            <div className='col-lg-5 offset-lg-1 text-center'>
              <Image
                ...
                alt={(data?.image as Media)?.alt || 'Appointment'}
